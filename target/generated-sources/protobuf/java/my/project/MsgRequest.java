...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof my.project.MsgRequest)) {
      return super.equals(obj);
    }
    my.project.MsgRequest other = (my.project.MsgRequest) obj;
  ...
  public static my.project.MsgRequest parseFrom(
  ...
  public static my.project.MsgRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static my.project.MsgRequest parseFrom(
  ...
  public static my.project.MsgRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static my.project.MsgRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static my.project.MsgRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(my.project.MsgRequest prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using my.project.MsgRequest.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public my.project.MsgRequest getDefaultInstanceForType() {
      return my.project.MsgRequest.getDefaultInstance();
    }

    @java.lang.Override
    public my.project.MsgRequest build() {
      my.project.MsgRequest result = buildPartial();
    ...
    @java.lang.Override
    public my.project.MsgRequest buildPartial() {
      my.project.MsgRequest result = new my.project.MsgRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(my.project.MsgRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof my.project.MsgRequest) {
        return mergeFrom((my.project.MsgRequest)other);
      } else {
    ...
    public Builder mergeFrom(my.project.MsgRequest other) {
      if (other == my.project.MsgRequest.getDefaultInstance()) return this;
  ...
  public static my.project.MsgRequest getDefaultInstance() {
